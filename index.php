...
<section class="hero">
    ...
    <div class="hero-texto">
        <h1>
            Informação, orientação e acolhimento para toda a família.
        </h1>
        ...
        <div class="botoes">
            <a href="paginas/guia.html" class="btn-principal">
                Começar agora
            </a>

            <a href="paginas/leis.html" class="btn-secundario">
...
<section class="apoio">
    ...
    <div>
        ...
        <p>
            Conheça um caminho inicial para compreender o
            diagnóstico, buscar apoio profissional e acessar
